    ...
    <body>
        ...
        <div class="hytPlayerWrapOuter">
            <div class="hytPlayerWrap"> <iframe width="464" height="316"
                    src="https://www.youtube.com/embed/<?php echo htmlspecialchars($_GET['id']); ?>?rel=0&enablejsapi=1&modestbranding=1&showinfo=0&autohide=1" allowfullscreen frameborder="0"></iframe></div>
        </div>
